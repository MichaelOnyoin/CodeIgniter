...
<body>
    <div class="mb-3 form-group">
        <!-- http://localhost/web_prac/fashInsertion.php -->
        <form action="fashionInserter" method="post" class="" id="">
            <h3 style="text-align: center;">Input Fashion</h3>
            <label for="" class="form-label">Fashion_id</label>
            <input type="number" name="fashion_id" id="" min="1" class="form-control form-control-sm" readonly><br>
