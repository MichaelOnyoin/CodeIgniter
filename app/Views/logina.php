...
<body class="login">
    ...
    <form name="login" action="processLogina" method="POST" onsubmit="return validation()" id="form" style="text-align: center; width: 500px; ">
        ...
        <input type="email" name="Email" id="email2" class=""><br>
