            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                      ...
                      <form action="<?php echo site_url("cloth/cart1");?>?id=<?=$row['fashion_id'] ?>" method="post">
                ...
                <div class="col-md-12">
                    ...
                    if(!empty($_SESSION['cart'])){
                        foreach($_SESSION['cart'] as $key => $value){
                            ...
                            <td><a href='cart1?action=remove&id=".$value['id']."'>
                    ...
                    // $sql="INSERT INTO `cart`(`user_id`,`fashion_id`,`fashion_item`,`unit_price`,`quantity`,`created_at`) VALUES ('$user_id','$fashion_id','$fashion_item','$unit_price','$quantity','')";
